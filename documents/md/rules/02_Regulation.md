...
以下の行為は禁止されています。違反した場合、スコアの取り消し、減点、0点、または失格となる場合があります。
...
- ユーザの認証に用いられるパスワードは、セキュリティの観点からハッシュ化を行っています。
  ...
  - ハッシュ化については、不可逆であれば、どのような方式に変更してもかまいません。
...
- このタイムアウト時間は、パフォーマンスや要件に応じて自由に変更できます。また、必要に応じてタイムアウト処理自体を無効化してもかまいません。
