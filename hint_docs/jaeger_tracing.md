...
### 目次
 ...
 - [2 分散トレーシングとは？](#2-分散トレーシングとは)  
 - [3 Jaegerってどんなツール？](#3-jaegerってどんなツール)  
 - [4 Jaegerの使い方](#4-jaegerの使い方)  
...
「分散トレーシング」というのは、**サービスがいくつかに分かれている場合でも、リクエストの流れを追いかけられるしくみ**です。
...
複数のサービスをまたぐリクエストでも、開始から終了までの流れを**一連のトレースとして追跡できます。

---

### 3 Jaegerってどんなツール？

[Jaeger（イェーガー）](https://www.jaegertracing.io/) は、トレーシングの情報を集めて、**見やすい画面で表示してくれるツール**です。
...
- VM 環境: 
https://{VMのドメイン名}.hutc2511.dabaas.net/jaeger/search
